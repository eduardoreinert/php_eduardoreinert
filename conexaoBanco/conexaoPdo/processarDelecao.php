...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        try{
            $stmt->execute();
            echo "<p id='msgSucesso'>Cliente excluído com sucesso!</p>";
...
<button onclick="window.location.href='deletarCliente.php'" id="botaoNovo" type="button" class="btn btn-primary">Nova Deleção</button>
</body>
</html>