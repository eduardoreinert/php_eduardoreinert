...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <?php
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            try{
                $stmt->execute();
                echo "<p id='msgSucesso'>Cliente cadastrado com sucesso!</p>";
    ...
    <button onclick="window.location.href='inserirCliente.php'" id="botaoNovo" type="button" class="btn btn-primary">Novo Cadastro</button>
</body>
</html>
